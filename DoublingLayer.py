...
class DuplicateLayer(Module):
    ...
    Examples::
        ...
        torch.Size([128, 30])
    """
    copied_layer: nn.Linear

    def __init__(self, copied_layer=None, device=None, dtype=None) -> None:
        factory_kwargs = {'device': device, 'dtype': dtype}
        super(DuplicateLayer, self).__init__()
        self.in_features = copied_layer.in_features
...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        duplicate = DuplicateLayer(self.linear_relu_stack[2])
